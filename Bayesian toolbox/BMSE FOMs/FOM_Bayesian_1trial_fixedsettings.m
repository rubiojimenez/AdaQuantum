...
% ADDED by Jesús Rubio: to learn more about the limited-data framework based on the quantum MMSQ (called 'bayes_bound' here), see:
%
%   [2] Rubio, J., and Dunningham, J. (2019). Quantum metrology in the presence of limited data. New Journal of Physics, 21 043037
%   [3] Rubio Jiménez, J. (2020). Non-asymptotic quantum metrology: extracting maximum information from limited data. PhD thesis, University of Sussex, ISNI: 0000 0004 8504 6357 (arXiv:1912.02324).
...
% Quantum MMSE (minimum mean square error)
